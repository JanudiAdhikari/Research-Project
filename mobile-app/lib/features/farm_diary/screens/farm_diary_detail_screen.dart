...
class _FarmDiaryDetailScreenState extends State<FarmDiaryDetailScreen>
  ...
  Widget _buildQuickInfoRow(FarmDiary entry, Responsive r) {
    return Padding(
      padding: EdgeInsets.symmetric(
        horizontal: r.value(mobile: 16, tablet: 28),
      ),
      child: Row(
        children: [
          _buildQuickStat(
          ...
          _buildQuickStat(
            ...
            entry.observations.plantHealth.toUpperCase(),
  ...
  Widget _buildWeatherSection(FarmDiary entry, Responsive r) {
    final hasWeather =
        ...
        (entry.weather.condition != 'unknown' &&
            entry.weather.condition.isNotEmpty);
  ...
  Widget _buildObservationsSection(FarmDiary entry, Responsive r) {
    return _buildSection(r, 'Observations', Icons.visibility_outlined, [
      ...
      if (entry.observations.pestPresence != null) const SizedBox(height: 12),
        ...
        children: [
          ...
          if (entry.inputs.waterQuantity != null)
            _buildInputBadge(
              r,
              'Water',
              '${entry.inputs.waterQuantity} Liters',
              Icons.opacity,
              Colors.blue,
            ),
        ],
        ...
        children: [
          ...
          _buildMetaRow(
            ...
            entry.updatedAt != null
                ? DateFormat('MMM dd, HH:mm').format(entry.updatedAt!)
                : '--',
          ),
        ],
      ),
  ...
  void _showDeleteDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'Are you sure you want to delete this diary entry forever?',
        ),
